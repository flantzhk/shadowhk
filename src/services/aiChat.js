...
import { API_BASE_URL, API_ENDPOINTS, MANDARIN_VOICE_ID } from '../utils/constants';
...
async function generateResponseAudio(chinese, scenario) {
  ...
  const voiceId = language === 'mandarin' ? MANDARIN_VOICE_ID : '99fb84cf-d081-4df6-8b8a-7165015a2f5d';
  try {
    return await textToSpeech(chinese, { language, speed: 0.9, outputExtension: 'mp3', voiceId });
  } catch (err) {
...
export { getScenarios, sendMessage, generateResponseAudio };
